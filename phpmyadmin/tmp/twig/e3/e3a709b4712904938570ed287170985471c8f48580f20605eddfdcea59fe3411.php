...
class __TwigTemplate_1e1b0870ee5d35369b63474c3176e42bc8508e11e0d294df4f261921b4d32f6b extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Grant");
        ...
        echo "</th>
                    ";
        // line 17
        if ((0 === twig_compare(($context["type"] ?? null), "database"))) {
            // line 18
            echo "                        <th scope=\"col\">";
...
echo _gettext("Action");
        echo "</th>
            ...
            <tbody>
                ";
        // line 27
        if ((0 === twig_compare(twig_length_filter($this->env, ($context["privileges"] ?? null)), 0))) {
            // line 28
            echo "                    ";
            $context["colspan"] = (((0 === twig_compare(($context["type"] ?? null), "database"))) ? (7) : ((((0 === twig_compare(($context["type"] ?? null), "table"))) ? (6) : (5))));
            // line 29
            echo "                    <tr>
